...
Hud.prototype.printItems = function(){
    for(i=0;i<this.items.length;i++){
        ...
        item = this.game.add.text(20, 20, key + ":" + value, this._getStyle("#000",16));
        item.setShadow(3, 3, 'rgba(255,0,0,0.3)', 6);
...
Hud.prototype.addTitle = function(title=null){
    ...
    title = this.game.add.text(0, 0, this.title_text, this._getStyle("#000",this.font_size,true));
    title.setShadow(3, 3, 'rgba(255,0,0,0.3)', 2);
