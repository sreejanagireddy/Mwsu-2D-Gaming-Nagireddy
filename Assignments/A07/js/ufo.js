...
function Ufo(game_copy) {
    ...
    this.preLoad = function (atlas_name='ufoAtlas', sprite_sheet='assets/sprites/spritesheet.png', atlas_json='assets/sprites/sprites.json') {
    ...
    this.create = function (x, y, x_scale, y_scale) {
        ...
        this.ship.animations.add('p', Phaser.Animation.generateFrameNames('p', 1, 12), 20, true);
        this.ship.animations.play('p');
