...
var preLoad = {
	preload:function(){
		...
		game.load.image('star', 'assets/images/star1.png');
		game.load.image('finish', 'assets/images/finish.jpg');
		//game.load.image('ghosts', 'assets/sprites/cat.png');

		//game.load.image('hud', 'assets/images/Shipwreck.png');
	...
	//	game.load.spritesheet('ghosts', 'assets/sprites/pacman_ghosts.png', 116, 116);
		...
		game.load.spritesheet('ghosts', 'assets/sprites/yyy.png', 80, 80);
	//	game.load.spritesheet('ghosts', 'assets/sprites/expressive.png', 116, 116);
		// load audio here: 
		...
		//this.getMap(" js/gameOver.js","gameOver",this.saveMap)
	},
